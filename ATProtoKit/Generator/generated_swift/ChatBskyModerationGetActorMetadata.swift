...
public struct Metadata: ATProtocolCodable, ATProtocolValue {
        ...
        public init(from decoder: Decoder) throws {
            ...
            do {
                ...
                print("Decoding error for property 'messagesSent': \(error)")
                throw error
            }
            do {
                ...
                print("Decoding error for property 'messagesReceived': \(error)")
                throw error
            }
            do {
                ...
                print("Decoding error for property 'convos': \(error)")
                throw error
            }
            do {
                ...
                print("Decoding error for property 'convosStarted': \(error)")
                throw error
            }
        }
