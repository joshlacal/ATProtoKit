...
public struct TemplateView: ATProtocolCodable, ATProtocolValue {
        ...
        public init(
            id: String, name: String, subject: String?, contentMarkdown: String, disabled: Bool, lastUpdatedBy: String, createdAt: ATProtocolDate, updatedAt: ATProtocolDate
        ) {
        ...
        public init(from decoder: Decoder) throws {
            ...
            do {
                ...
                print("Decoding error for property 'contentMarkdown': \(error)")
                throw error
            }
            do {
            ...
            do {
                ...
                print("Decoding error for property 'lastUpdatedBy': \(error)")
                throw error
            }
            do {
