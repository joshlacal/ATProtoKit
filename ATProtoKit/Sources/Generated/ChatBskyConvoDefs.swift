...
public struct MessageRef: ATProtocolCodable, ATProtocolValue {
        ...
        public init(from decoder: Decoder) throws {
            ...
            do {
                ...
                print("Decoding error for property 'messageId': \(error)")
                throw error
            }
        }
...
public struct MessageInput: ATProtocolCodable, ATProtocolValue {
        ...
        public init(from decoder: Decoder) throws {
            ...
            do {
                ...
                print("Decoding error for property 'text': \(error)")
                throw error
            }
            do {
                ...
                print("Decoding error for property 'facets': \(error)")
                throw error
            }
            do {
...
public struct MessageView: ATProtocolCodable, ATProtocolValue {
        ...
        public init(from decoder: Decoder) throws {
            ...
            do {
                ...
                print("Decoding error for property 'sender': \(error)")
                throw error
            }
            do {
                ...
                print("Decoding error for property 'sentAt': \(error)")
                throw error
            }
        }
...
public struct ConvoView: ATProtocolCodable, ATProtocolValue {
        ...
        public init(from decoder: Decoder) throws {
            ...
            do {
                ...
                print("Decoding error for property 'members': \(error)")
                throw error
            }
            do {
                ...
                print("Decoding error for property 'lastMessage': \(error)")
                throw error
            }
            do {
            ...
            do {
                ...
                print("Decoding error for property 'unreadCount': \(error)")
                throw error
            }
        }
