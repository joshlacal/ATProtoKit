...
public struct AppBskyFeedPost: ATProtocolCodable, ATProtocolValue {
    ...
    public init(
        ...
        reply: ReplyRef?,
        embed: AppBskyFeedPostEmbedUnion?,
        langs: [LanguageCodeContainer]?,
        labels: AppBskyFeedPostLabelsUnion?,
        tags: [String]?,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.entities = try container
            .decodeIfPresent([Entity].self, forKey: .entities)
            
        self.facets = try container
            .decodeIfPresent([AppBskyRichtextFacet].self, forKey: .facets)
            
        self.reply = try container
            .decodeIfPresent(ReplyRef.self, forKey: .reply)
            
        self.embed = try container
            .decodeIfPresent(AppBskyFeedPostEmbedUnion.self, forKey: .embed)
            
        self.langs = try container
            .decodeIfPresent([LanguageCodeContainer].self, forKey: .langs)
            
        self.labels = try container
            .decodeIfPresent(AppBskyFeedPostLabelsUnion.self, forKey: .labels)
            
        self.tags = try container.decodeIfPresent([String].self, forKey: .tags)
            
        self.createdAt = try container
            .decode(ATProtocolDate.self, forKey: .createdAt)
    }
        ...
        public init(from decoder: Decoder) throws {
            ...
            do {
                self.root = try container
                    .decode(ComAtprotoRepoStrongRef.self, forKey: .root)
            ...
            do {
                self.parent = try container
                    .decode(ComAtprotoRepoStrongRef.self, forKey: .parent)
    ...
    public struct Entity: ATProtocolCodable, ATProtocolValue {
        ...
        public init(from decoder: Decoder) throws {
            let container = try decoder.container(keyedBy: CodingKeys.self)
            do {
                self.index = try container
                    .decode(TextSlice.self, forKey: .index)
    ...
    public enum AppBskyFeedPostEmbedUnion: Codable, ATProtocolCodable, ATProtocolValue {
        ...
        public init(from decoder: Decoder) throws {
            ...
            default:
                print(
                    "AppBskyFeedPostEmbedUnion decoding encountered an unexpected type: \(typeValue)"
                )
        ...
        public func encode(to encoder: Encoder) throws {
            ...
            case .appBskyEmbedRecordWithMedia(let value):
                ...
                try container
                    .encode("app.bsky.embed.recordWithMedia", forKey: .type)
                try value.encode(to: encoder)
        ...
        public func isEqual(to other: any ATProtocolValue) -> Bool {
            guard let otherValue = other as? AppBskyFeedPostEmbedUnion else {
                return false
            }
    ...
    public enum AppBskyFeedPostLabelsUnion: Codable, ATProtocolCodable, ATProtocolValue {
        ...
        public init(from decoder: Decoder) throws {
            ...
            default:
                print(
                    "AppBskyFeedPostLabelsUnion decoding encountered an unexpected type: \(typeValue)"
                )
                let unknownValue = try ATProtocolValueContainer(from: decoder)
                self = .unexpected(unknownValue)
            }
        ...
        public func encode(to encoder: Encoder) throws {
            ...
            case .comAtprotoLabelDefsSelfLabels(let value):
                ...
                try container
                    .encode("com.atproto.label.defs#selfLabels", forKey: .type)
                try value.encode(to: encoder)
            case .unexpected(let ATProtocolValueContainer):
        ...
        public func isEqual(to other: any ATProtocolValue) -> Bool {
            guard let otherValue = other as? AppBskyFeedPostLabelsUnion else {
                return false
            }
