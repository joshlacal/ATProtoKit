public indirect enum ATProtocolValueContainer: ATProtocolCodable, ATProtocolValue {
        ...
        init() {
            ...
            decoders["app.bsky.graph.defs#starterPackView"] = { decoder in
                do {
                    ...
                    print("Error decoding AppBskyGraphDefs.StarterPackView: \(error)")
            ...
            decoders["app.bsky.graph.defs#starterPackViewBasic"] = { decoder in
                do {
                    ...
                    print("Error decoding AppBskyGraphDefs.StarterPackViewBasic: \(error)")
            ...
            decoders["app.bsky.graph.starterpack"] = { decoder in
                do {
                    ...
                    print("Error decoding AppBskyGraphStarterpack: \(error)")
            ...
            decoders["app.bsky.graph.starterpack#feedItem"] = { decoder in
                do {
                    ...
                    print("Error decoding AppBskyGraphStarterpack.FeedItem: \(error)")
            ...
            decoders["app.bsky.actor.defs#knownFollowers"] = { decoder in
                do {
                    ...
                    print("Error decoding AppBskyActorDefs.KnownFollowers: \(error)")
            ...
            decoders["app.bsky.actor.defs#bskyAppStatePref"] = { decoder in
                do {
                    ...
                    print("Error decoding AppBskyActorDefs.BskyAppStatePref: \(error)")
            ...
            decoders["app.bsky.actor.defs#bskyAppProgressGuide"] = { decoder in
                do {
                    ...
                    print("Error decoding AppBskyActorDefs.BskyAppProgressGuide: \(error)")
            ...
            decoders["tools.ozone.server.getConfig#serviceConfig"] = { decoder in
                do {
                    ...
                    print("Error decoding ToolsOzoneServerGetConfig.ServiceConfig: \(error)")
            ...
            decoders["tools.ozone.server.getConfig#viewerConfig"] = { decoder in
                do {
                    ...
                    print("Error decoding ToolsOzoneServerGetConfig.ViewerConfig: \(error)")
            ...
            decoders["tools.ozone.team.defs#member"] = { decoder in
                do {
                    ...
                    print("Error decoding ToolsOzoneTeamDefs.Member: \(error)")
    ...
    private static func decodeSingleValue(from decoder: Decoder) throws -> ATProtocolValueContainer {
        ...
        print("Failed to decode as basic type, attempting to decode as Array or Object")
        ...
        print("Failed to decode as Array or Object, throwing DecodingError.dataCorruptedError")
        ...
        for key in container.allKeys {
            ...
            if let boolValue = try? container.decode(Bool.self, forKey: key) {
                ...
                while !arrayContainer.isAtEnd {
                    print("Decoding array element at index \(arrayContainer.currentIndex)")
    ...
    private static func decodeAny(from unkeyedContainer: inout UnkeyedDecodingContainer) throws -> [ATProtocolValueContainer] {
        ...
        while !unkeyedContainer.isAtEnd {
            print("Decoding array element at index \(unkeyedContainer.currentIndex)")
            if let value = try? unkeyedContainer.decode(Bool.self) {
                ...
                print("Cannot decode array element at index \(unkeyedContainer.currentIndex)")
