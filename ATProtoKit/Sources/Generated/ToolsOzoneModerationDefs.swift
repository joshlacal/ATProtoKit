...
public struct SubjectStatusView: ATProtocolCodable, ATProtocolValue {
        ...
        // Standard initializer
        public init(
            id: Int, subject: SubjectStatusViewSubjectUnion, subjectBlobCids: [String]?, subjectRepoHandle: String?, updatedAt: ATProtocolDate, createdAt: ATProtocolDate, reviewState: SubjectReviewState, comment: String?, muteUntil: ATProtocolDate?, lastReviewedBy: String?, lastReviewedAt: ATProtocolDate?, lastReportedAt: ATProtocolDate?, lastAppealedAt: ATProtocolDate?, takendown: Bool?, appealed: Bool?, suspendUntil: ATProtocolDate?, tags: [String]?
        ) {
...
public struct ModEventEmail: ATProtocolCodable, ATProtocolValue {
        ...
        public init(from decoder: Decoder) throws {
            ...
            do {
                ...
                print("Decoding error for property 'content': \(error)")
                throw error
            }
            do {
...
public struct ModEventTag: ATProtocolCodable, ATProtocolValue {
        ...
        public init(from decoder: Decoder) throws {
            ...
            do {
                ...
                print("Decoding error for property 'add': \(error)")
                throw error
            }
            do {
                ...
                print("Decoding error for property 'remove': \(error)")
                throw error
            }
            do {
