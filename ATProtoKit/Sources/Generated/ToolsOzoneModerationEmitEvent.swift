...
public enum ToolsOzoneModerationEmitEventEventUnion: Codable, ATProtocolCodable, ATProtocolValue {
    ...
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        let typeValue = try container.decode(String.self, forKey: .type)
        print("ToolsOzoneModerationEmitEventEventUnion decoding: \(typeValue)")
        ...
        case "tools.ozone.moderation.defs#modEventTag":
            ...
            self = .toolsOzoneModerationDefsModEventTag(value)
        default:
            print("ToolsOzoneModerationEmitEventEventUnion decoding encountered an unexpected type: \(typeValue)")
            let unknownValue = try ATProtocolValueContainer(from: decoder)
            self = .unexpected(unknownValue)
        }
    }
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        case .toolsOzoneModerationDefsModEventTag(let value):
            ...
            try value.encode(to: encoder)
        case .unexpected(let ATProtocolValueContainer):
            print("ToolsOzoneModerationEmitEventEventUnion encoding unexpected value")
            try ATProtocolValueContainer.encode(to: encoder)
        }
    }
...
public enum ToolsOzoneModerationEmitEventSubjectUnion: Codable, ATProtocolCodable, ATProtocolValue {
    ...
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        let typeValue = try container.decode(String.self, forKey: .type)
        print("ToolsOzoneModerationEmitEventSubjectUnion decoding: \(typeValue)")
        ...
        case "com.atproto.repo.strongRef":
            ...
            self = .comAtprotoRepoStrongRef(value)
        default:
            print("ToolsOzoneModerationEmitEventSubjectUnion decoding encountered an unexpected type: \(typeValue)")
            let unknownValue = try ATProtocolValueContainer(from: decoder)
            self = .unexpected(unknownValue)
        }
    }
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        case .comAtprotoRepoStrongRef(let value):
            ...
            try value.encode(to: encoder)
        case .unexpected(let ATProtocolValueContainer):
            print("ToolsOzoneModerationEmitEventSubjectUnion encoding unexpected value")
            try ATProtocolValueContainer.encode(to: encoder)
        }
    }
