...
extension ATProtoClient.Tools.Ozone.Team {
    ...
    public func addMember(input: ToolsOzoneTeamAddMember.Input, duringInitialSetup: Bool = false) async throws -> (responseCode: Int, data: ToolsOzoneTeamAddMember.Output?) {
