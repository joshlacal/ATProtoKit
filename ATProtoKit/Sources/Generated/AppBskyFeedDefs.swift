...
public struct ViewerState: ATProtocolCodable, ATProtocolValue {
        ...
        // Standard initializer
        public init(
            repost: ATProtocolURI?, like: ATProtocolURI?, threadMuted: Bool?, replyDisabled: Bool?
        ) {
        ...
        public init(from decoder: Decoder) throws {
            ...
            do {
                ...
                print("Decoding error for property 'threadMuted': \(error)")
                throw error
            }
            do {
...
public struct ReplyRef: ATProtocolCodable, ATProtocolValue {
        ...
        public init(from decoder: Decoder) throws {
            ...
            do {
                ...
                print("Decoding error for property 'grandparentAuthor': \(error)")
                throw error
            }
        }
...
public struct GeneratorView: ATProtocolCodable, ATProtocolValue {
        ...
        public init(from decoder: Decoder) throws {
            ...
            do {
                ...
                print("Decoding error for property 'acceptsInteractions': \(error)")
                throw error
            }
            do {
