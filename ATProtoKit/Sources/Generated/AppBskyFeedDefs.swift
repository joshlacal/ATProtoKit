...
public struct AppBskyFeedDefs {
    ...
    public struct PostView: ATProtocolCodable, ATProtocolValue {
        ...
        public init(from decoder: Decoder) throws {
            ...
            do {
                self.uri = try container
                    .decode(ATProtocolURI.self, forKey: .uri)
            ...
            do {
                self.author = try container
                    .decode(
                        AppBskyActorDefs.ProfileViewBasic.self,
                        forKey: .author
                    )
            ...
            do {
                self.record = try container
                    .decode(ATProtocolValueContainer.self, forKey: .record)
            ...
            do {
                self.embed = try container
                    .decodeIfPresent(PostViewEmbedUnion.self, forKey: .embed)
            ...
            do {
                self.replyCount = try container
                    .decodeIfPresent(Int.self, forKey: .replyCount)
            ...
            do {
                self.repostCount = try container
                    .decodeIfPresent(Int.self, forKey: .repostCount)
            ...
            do {
                self.likeCount = try container
                    .decodeIfPresent(Int.self, forKey: .likeCount)
            ...
            do {
                self.indexedAt = try container
                    .decode(ATProtocolDate.self, forKey: .indexedAt)
            ...
            do {
                self.viewer = try container
                    .decodeIfPresent(ViewerState.self, forKey: .viewer)
            ...
            do {
                self.labels = try container
                    .decodeIfPresent(
                        [ComAtprotoLabelDefs.Label].self,
                        forKey: .labels
                    )
            ...
            do {
                self.threadgate = try container
                    .decodeIfPresent(ThreadgateView.self, forKey: .threadgate)
    ...
    public struct ViewerState: ATProtocolCodable, ATProtocolValue {
        ...
        public init(from decoder: Decoder) throws {
            let container = try decoder.container(keyedBy: CodingKeys.self)
            do {
                self.repost = try container
                    .decodeIfPresent(ATProtocolURI.self, forKey: .repost)
            ...
            do {
                self.like = try container
                    .decodeIfPresent(ATProtocolURI.self, forKey: .like)
            ...
            do {
                self.replyDisabled = try container
                    .decodeIfPresent(Bool.self, forKey: .replyDisabled)
    ...
    public struct FeedViewPost: ATProtocolCodable, ATProtocolValue {
        ...
        public init(from decoder: Decoder) throws {
            ...
            do {
                self.reply = try container
                    .decodeIfPresent(ReplyRef.self, forKey: .reply)
            ...
            do {
                self.feedContext = try container
                    .decodeIfPresent(String.self, forKey: .feedContext)
                
            } catch {
                print("Decoding error for property 'feedContext': \(error)")
                throw error
            }
        }
    ...
    public struct ReplyRef: ATProtocolCodable, ATProtocolValue {
        ...
        public init(from decoder: Decoder) throws {
            let container = try decoder.container(keyedBy: CodingKeys.self)
            do {
                self.root = try container
                    .decode(ReplyRefRootUnion.self, forKey: .root)
            ...
            do {
                self.parent = try container
                    .decode(ReplyRefParentUnion.self, forKey: .parent)
            ...
            do {
                self.grandparentAuthor = try container
                    .decodeIfPresent(
                        AppBskyActorDefs.ProfileViewBasic.self,
                        forKey: .grandparentAuthor
                    )
                
            } catch {
                print(
                    "Decoding error for property 'grandparentAuthor': \(error)"
                )
                throw error
            }
        }
    ...
    public struct ReasonRepost: ATProtocolCodable, ATProtocolValue {
        ...
        public init(from decoder: Decoder) throws {
            let container = try decoder.container(keyedBy: CodingKeys.self)
            do {
                self.by = try container
                    .decode(AppBskyActorDefs.ProfileViewBasic.self, forKey: .by)
    ...
    public struct ThreadViewPost: ATProtocolCodable, ATProtocolValue {
        ...
        public init(
            ...
            replies: [ThreadViewPostRepliesUnion]?
        ) {
            self.post = post
            self.parent = parent
        ...
        public init(from decoder: Decoder) throws {
            ...
            do {
                self.parent = try container
                    .decodeIfPresent(
                        ThreadViewPostParentUnion.self,
                        forKey: .parent
                    )
            ...
            do {
                self.replies = try container
                    .decodeIfPresent(
                        [ThreadViewPostRepliesUnion].self,
                        forKey: .replies
                    )
    ...
    public struct NotFoundPost: ATProtocolCodable, ATProtocolValue {
        ...
        public init(from decoder: Decoder) throws {
            ...
            do {
                self.notFound = try container
                    .decode(Bool.self, forKey: .notFound)
    ...
    public struct BlockedPost: ATProtocolCodable, ATProtocolValue {
        ...
        public init(from decoder: Decoder) throws {
            ...
            do {
                self.author = try container
                    .decode(BlockedAuthor.self, forKey: .author)
    ...
    public struct BlockedAuthor: ATProtocolCodable, ATProtocolValue {
        ...
        public init(from decoder: Decoder) throws {
            ...
            do {
                self.viewer = try container
                    .decodeIfPresent(
                        AppBskyActorDefs.ViewerState.self,
                        forKey: .viewer
                    )
        ...
        public init(from decoder: Decoder) throws {
            ...
            do {
                self.creator = try container
                    .decode(AppBskyActorDefs.ProfileView.self, forKey: .creator)
            ...
            do {
                self.displayName = try container
                    .decode(String.self, forKey: .displayName)
            ...
            do {
                self.descriptionFacets = try container
                    .decodeIfPresent(
                        [AppBskyRichtextFacet].self,
                        forKey: .descriptionFacets
                    )
                
            } catch {
                print(
                    "Decoding error for property 'descriptionFacets': \(error)"
                )
                throw error
            }
            do {
                self.avatar = try container
                    .decodeIfPresent(URI.self, forKey: .avatar)
            ...
            do {
                self.acceptsInteractions = try container
                    .decodeIfPresent(Bool.self, forKey: .acceptsInteractions)
                
            } catch {
                print(
                    "Decoding error for property 'acceptsInteractions': \(error)"
                )
                throw error
            }
            do {
            ...
            do {
                self.viewer = try container
                    .decodeIfPresent(GeneratorViewerState.self, forKey: .viewer)
    ...
    public struct SkeletonFeedPost: ATProtocolCodable, ATProtocolValue {
        ...
        public init(from decoder: Decoder) throws {
            let container = try decoder.container(keyedBy: CodingKeys.self)
            do {
                self.post = try container
                    .decode(ATProtocolURI.self, forKey: .post)
            ...
            do {
                self.reason = try container
                    .decodeIfPresent(
                        SkeletonFeedPostReasonUnion.self,
                        forKey: .reason
                    )
    ...
    public struct SkeletonReasonRepost: ATProtocolCodable, ATProtocolValue {
        ...
        public init(from decoder: Decoder) throws {
            ...
            do {
                self.repost = try container
                    .decode(ATProtocolURI.self, forKey: .repost)
    ...
    public struct ThreadgateView: ATProtocolCodable, ATProtocolValue {
        ...
        public init(from decoder: Decoder) throws {
            ...
            do {
                self.uri = try container
                    .decodeIfPresent(ATProtocolURI.self, forKey: .uri)
            ...
            do {
                self.cid = try container
                    .decodeIfPresent(String.self, forKey: .cid)
            ...
            do {
                self.lists = try container
                    .decodeIfPresent(
                        [AppBskyGraphDefs.ListViewBasic].self,
                        forKey: .lists
                    )
    ...
    public struct Interaction: ATProtocolCodable, ATProtocolValue {
        ...
        public init(from decoder: Decoder) throws {
            let container = try decoder.container(keyedBy: CodingKeys.self)
            do {
                self.item = try container
                    .decodeIfPresent(ATProtocolURI.self, forKey: .item)
                
            } catch {
                print("Decoding error for property 'item': \(error)")
                throw error
            }
            do {
                self.event = try container
                    .decodeIfPresent(String.self, forKey: .event)
    ...
    public enum PostViewEmbedUnion: Codable, ATProtocolCodable, ATProtocolValue {
        ...
        public init(from decoder: Decoder) throws {
            ...
            default:
                print(
                    "PostViewEmbedUnion decoding encountered an unexpected type: \(typeValue)"
                )
        ...
        public func isEqual(to other: any ATProtocolValue) -> Bool {
            guard let otherValue = other as? PostViewEmbedUnion else {
                return false
            }
    ...
    public enum FeedViewPostReasonUnion: Codable, ATProtocolCodable, ATProtocolValue {
        ...
        public init(from decoder: Decoder) throws {
            ...
            default:
                print(
                    "FeedViewPostReasonUnion decoding encountered an unexpected type: \(typeValue)"
                )
                let unknownValue = try ATProtocolValueContainer(from: decoder)
                self = .unexpected(unknownValue)
            }
        ...
        public func encode(to encoder: Encoder) throws {
            ...
            case .appBskyFeedDefsReasonRepost(let value):
                ...
                try container
                    .encode("app.bsky.feed.defs#reasonRepost", forKey: .type)
                try value.encode(to: encoder)
            case .unexpected(let ATProtocolValueContainer):
        ...
        public func isEqual(to other: any ATProtocolValue) -> Bool {
            guard let otherValue = other as? FeedViewPostReasonUnion else {
                return false
            }
    ...
    public enum ReplyRefRootUnion: Codable, ATProtocolCodable, ATProtocolValue {
        ...
        public init(from decoder: Decoder) throws {
            ...
            default:
                print(
                    "ReplyRefRootUnion decoding encountered an unexpected type: \(typeValue)"
                )
                let unknownValue = try ATProtocolValueContainer(from: decoder)
                self = .unexpected(unknownValue)
            }
        ...
        public func isEqual(to other: any ATProtocolValue) -> Bool {
            guard let otherValue = other as? ReplyRefRootUnion else {
                return false
            }
    ...
    public enum ReplyRefParentUnion: Codable, ATProtocolCodable, ATProtocolValue {
        ...
        public init(from decoder: Decoder) throws {
            ...
            default:
                print(
                    "ReplyRefParentUnion decoding encountered an unexpected type: \(typeValue)"
                )
                let unknownValue = try ATProtocolValueContainer(from: decoder)
                self = .unexpected(unknownValue)
            }
        ...
        public func isEqual(to other: any ATProtocolValue) -> Bool {
            guard let otherValue = other as? ReplyRefParentUnion else {
                return false
            }
    ...
    public indirect enum ThreadViewPostParentUnion: Codable, ATProtocolCodable, ATProtocolValue {
        ...
        public init(from decoder: Decoder) throws {
            ...
            default:
                print(
                    "ThreadViewPostParentUnion decoding encountered an unexpected type: \(typeValue)"
                )
                let unknownValue = try ATProtocolValueContainer(from: decoder)
                self = .unexpected(unknownValue)
            }
        ...
        public func encode(to encoder: Encoder) throws {
            ...
            case .appBskyFeedDefsThreadViewPost(let value):
                ...
                try container
                    .encode("app.bsky.feed.defs#threadViewPost", forKey: .type)
                try value.encode(to: encoder)
            case .appBskyFeedDefsNotFoundPost(let value):
                print("Encoding app.bsky.feed.defs#notFoundPost")
                try container
        ...
        public func isEqual(to other: any ATProtocolValue) -> Bool {
            guard let otherValue = other as? ThreadViewPostParentUnion else {
                return false
            }
    ...
    public indirect enum ThreadViewPostRepliesUnion: Codable, ATProtocolCodable, ATProtocolValue {
        ...
        public init(from decoder: Decoder) throws {
            ...
            default:
                print(
                    "ThreadViewPostRepliesUnion decoding encountered an unexpected type: \(typeValue)"
                )
                let unknownValue = try ATProtocolValueContainer(from: decoder)
                self = .unexpected(unknownValue)
            }
        ...
        public func isEqual(to other: any ATProtocolValue) -> Bool {
            guard let otherValue = other as? ThreadViewPostRepliesUnion else {
                return false
            }
    ...
    public enum SkeletonFeedPostReasonUnion: Codable, ATProtocolCodable, ATProtocolValue {
        case appBskyFeedDefsSkeletonReasonRepost(
        ...
        public init(from decoder: Decoder) throws {
            ...
            case "app.bsky.feed.defs#skeletonReasonRepost":
                ...
                let value = try AppBskyFeedDefs.SkeletonReasonRepost(
                    from: decoder
                )
                self = .appBskyFeedDefsSkeletonReasonRepost(value)
            default:
                print(
                    "SkeletonFeedPostReasonUnion decoding encountered an unexpected type: \(typeValue)"
                )
                let unknownValue = try ATProtocolValueContainer(from: decoder)
                self = .unexpected(unknownValue)
            }
        ...
        public func isEqual(to other: any ATProtocolValue) -> Bool {
            guard let otherValue = other as? SkeletonFeedPostReasonUnion else {
                return false
            }
