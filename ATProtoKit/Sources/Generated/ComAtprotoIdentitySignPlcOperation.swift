...
extension ATProtoClient.Com.Atproto.Identity {
    ...
    public func signPlcOperation(input: ComAtprotoIdentitySignPlcOperation.Input) async throws -> (responseCode: Int, data: ComAtprotoIdentitySignPlcOperation.Output?) {
