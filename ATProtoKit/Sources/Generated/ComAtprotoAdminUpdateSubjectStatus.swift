...
public enum ComAtprotoAdminUpdateSubjectStatusSubjectUnion: Codable, ATProtocolCodable, ATProtocolValue {
    ...
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        let typeValue = try container.decode(String.self, forKey: .type)
        print("ComAtprotoAdminUpdateSubjectStatusSubjectUnion decoding: \(typeValue)")
        ...
        case "com.atproto.admin.defs#repoBlobRef":
            ...
            self = .comAtprotoAdminDefsRepoBlobRef(value)
        default:
            print("ComAtprotoAdminUpdateSubjectStatusSubjectUnion decoding encountered an unexpected type: \(typeValue)")
            let unknownValue = try ATProtocolValueContainer(from: decoder)
            self = .unexpected(unknownValue)
        }
    }
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        case .comAtprotoAdminDefsRepoBlobRef(let value):
            ...
            try value.encode(to: encoder)
        case .unexpected(let ATProtocolValueContainer):
            print("ComAtprotoAdminUpdateSubjectStatusSubjectUnion encoding unexpected value")
            try ATProtocolValueContainer.encode(to: encoder)
        }
    }
