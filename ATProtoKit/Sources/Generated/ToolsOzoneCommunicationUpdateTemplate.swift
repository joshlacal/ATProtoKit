...
extension ATProtoClient.Tools.Ozone.Communication {
    ...
    public func updateTemplate(input: ToolsOzoneCommunicationUpdateTemplate.Input) async throws -> (responseCode: Int, data: ToolsOzoneCommunicationUpdateTemplate.Output?) {
