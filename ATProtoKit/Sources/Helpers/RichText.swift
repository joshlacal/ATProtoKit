...
public func createFacets(forMentions mentions: [TextSegment], andLinks links: [TextSegment]) -> [AppBskyRichtextFacet] {
    ...
    for mention in mentions {
        ...
        let facet = AppBskyRichtextFacet(index: byteSlice, features: [.appBskyRichtextFacet_Mention(mentionFeature)])
        facets.append(facet)
    }
    ...
    for link in links {
        ...
        let facet = AppBskyRichtextFacet(index: byteSlice, features: [.appBskyRichtextFacet_Link(linkFeature)])
        facets.append(facet)
    }
