...
//        }
//        
//        self.app = App(networkManager: networkManager)
//        self.chat = Chat(networkManager: networkManager)
//        self.com = Com(networkManager: networkManager)
//        self.tools = Tools(networkManager: networkManager)
//
//    }
//
//
